...
(defrule RicoRico_Filtrado::eliminar_platos_complejos
    ...
    (test (or 
          (and (> ?comensales 10) (> ?dificultad 9))
          (and (> ?comensales 20) (> ?dificultad 8))
          (and (> ?comensales 30) (> ?dificultad 7))
          (and (> ?comensales 40) (> ?dificultad 6))
          (and (> ?comensales 50) (> ?dificultad 5))
          (and (> ?comensales 60) (> ?dificultad 4))
          (and (> ?comensales 70) (> ?dificultad 3))
          (and (> ?comensales 80) (> ?dificultad 2))
          (and (> ?comensales 90) (> ?dificultad 1))))
...
(defrule RicoRico_Filtrado::eliminar_platos_fuera_temporada
    ...
    (test (member$ (instance-name ?ingrediente) ?ingredienteList))
    (test (not (member$ (instance-name ?temporada) ?disponibles)))
    =>
    (send ?plato delete)
)
...
(defrule RicoRico_Filtrado::eliminar_bebidas_lactosa
    (declare (salience 10))
    (preferencias (intolerancia_lactosa TRUE))
    ?bebida <- (object (is-a Bebida) (lactosaFree FALSE))
    =>
    (send ?bebida delete)
)
...
(defrule RicoRico_Filtrado::eliminar_bebidas_gluten
    (declare (salience 10))
    (preferencias (intolerancia_gluten TRUE))
    ?bebida <- (object (is-a Bebida) (glutenFree FALSE))
    =>
    (send ?bebida delete)
)
